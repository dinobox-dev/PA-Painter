...
static BUILT_IN: OnceLock<PresetLibrary> = OnceLock::new();

impl PresetLibrary {
    /// Built-in default presets. Allocated once; subsequent calls return the same instance.
    ///
    /// The first preset in the list is used as [`PaintValues::default()`].
    pub fn built_in() -> &'static PresetLibrary {
