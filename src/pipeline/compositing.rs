...
//!
//! Blends stroke height, color, gradient, stroke-ID, and stroke-time contributions
//! from all visible paint layers into a single [`GlobalMaps`] struct, respecting
//! layer ordering and per-layer distance-field clipping.
